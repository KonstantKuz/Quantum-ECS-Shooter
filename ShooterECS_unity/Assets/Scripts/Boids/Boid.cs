...
namespace Boids
{
    public class Boid : MonoBehaviour
    {
        ...
        public float maxDistanceFromAnchor = 25;
        ...
        void CalculateVelocity()
        {
            ...
            cohesion = Vector3.ClampMagnitude(cohesion - transform.position, maxSpeed);
        ...
        void Update()
        {
            ...
            if (Vector3.Distance(transform.position, anchor) > maxDistanceFromAnchor)
            {
                velocity += (anchor - transform.position) / maxDistanceFromAnchor;
            }
